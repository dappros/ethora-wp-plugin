...
= 1.4.0 =
This update addresses WordPress plugin review compliance by removing all external dependencies and integrating the official Ethora assistant JavaScript file locally. The plugin now provides the authentic Ethora assistant functionality while meeting WordPress.org guidelines.
